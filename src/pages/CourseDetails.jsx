...
// console.log("Apun idhar hai",response?.data)
  const {
    _id: _id,
    courseName,
    courseDescription,
  ...
  const {
    createdAt
  } = response?.data[0]?.instructor
  // console.log("instructor ka data",instructor)
  // console.log("id",_id)
  // console.log("student enrolled ka data",studentsEnrolled)
